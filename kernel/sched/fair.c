...
static inline int walt_same_cluster(int src_cpu, int dst_cpu)
{
...
static int
walt_select_task_rq_fair(struct task_struct *p, int prev_cpu,
...
#ifdef CONFIG_SMP
	.select_task_rq		= walt_select_task_rq_fair,
